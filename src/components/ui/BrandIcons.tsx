/**
 * Íconos de marca en SVG inline.
 *
 * lucide-react v1 eliminó los íconos de marcas (Instagram, Facebook,
 * YouTube, LinkedIn) por razones de licencia, así que se dibujan acá.
 * Son paths de relleno sólido (no de trazo), por eso usan currentColor
 * en `fill` y no en `stroke`.
 */
